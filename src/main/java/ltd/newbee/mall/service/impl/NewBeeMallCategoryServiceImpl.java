...
public class NewBeeMallCategoryServiceImpl implements NewBeeMallCategoryService {
    ...
    public String updateGoodsCategory(GoodsCategory goodsCategory) {
        System.out.println(goodsCategoryMapper);
    ...
    public SearchPageCategoryVO getCategoriesForSearch(Long categoryId) {
        ...
        if (thirdLevelGoodsCategory != null && thirdLevelGoodsCategory.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel()) {
            ...
            //获取一级分类名称
            GoodsCategory secondLevelGoodsCategorys = goodsCategoryMapper.selectByPrimaryKey(secondLevelGoodsCategory.getParentId());
            searchPageCategoryVO.setFirstLevelCategoryName(secondLevelGoodsCategorys.getCategoryName());
