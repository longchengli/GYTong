$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '信息编号', name: 'goodsId', index: 'goodsId', width: 60, key: true},
            {label: '信息名', name: 'goodsName', index: 'goodsName', width: 120},
            {label: '信息简介', name: 'goodsIntro', index: 'goodsIntro', width: 120},
            {label: '信息主图', name: 'goodsCoverImg', index: 'goodsCoverImg', width: 120, formatter: coverImageFormatter},
    ...
    function goodsSellStatusFormatter(cellvalue) {
        ...
        if (cellvalue == 1) {
            return "<button type=\"button\" class=\"btn btn-block btn-secondary btn-sm\" style=\"width: 80%;\">已失效</button>";
        }
    }
