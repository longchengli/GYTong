    ...
    new AjaxUpload('#uploadGoodsCoverImg', {
        ...
        onComplete: function (file, r) {
            if (r != null && r.resultCode == 200) {
                ...
                $("#goodsCoverImg").attr("style", "width: 180px;height: 200px;display:block;margin-left: 10px;");
                return false;
            } else {
                alert("error");
            }
...
$('#levelOne').on('change', function () {
    $.ajax({
        url: '/categories/listForSelect?categoryId=' + $(this).val(),
        type: 'GET',
        success: function (result) {
            if (result.resultCode == 200) {
                var levelTwoSelect = '';
